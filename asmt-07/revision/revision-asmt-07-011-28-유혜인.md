---
title: (개선) 과제-07 개인별 논증 구조 작성하기 011-28 유혜인
layout: home
nav_order: 99
parent: 011-28 유혜인 (과제-07)
permalink: /asmt-07/011-28/revision
---

# (개선) 과제-07 개인별 논증 구조 작성하기 011-28 유혜인 

## 개선 사항 메모

각 근거의 구체적인 자료를 제시해 전제의 신뢰성을 강화하였다. 또한 논제의 핵심 단어인 '성소수자 해방'이 구체적으로 무엇인지 정의했다. 전제 간의 논리적인 연결을 강화했다. 

## 제목: 미디어에서의 성소수자 재현의 양적 증가는 해방을 위한 필수적 출발점이다
...
| 도전하려는 쟁점 | 미디어에서의 성소수자 재현의 양적 증가는 사회적 인식 개선을 가져오는가 |
| 딜레마/난제 |  미디어에서의 성소수자 재현의 양적 증가는 사회적 인식을 개선하는가 아니면 ‘정상적 퀴어’ 생산으로 인한 또 다른 억압을 강화하는가  |
| 딜레마/난제 해소/해결 방법 | 사회적 인식의 개선은 성소수자의 완전한 재현보다는 미디어에서의 성소수자 재현의 양적 증가를 통한 '성소수자의 드러냄'에서 시작된다는 논증 |
...
- **재현의 양적 증가는 그 방식의 왜곡 위험에도 불구하고 존재의 ‘보임’ 자체가 더 우선되어야 하는가?** 
...
- **논제:** 미디어에서의 성소수자 재현의 양적 증가는 성소수자 해방을 위한 필수적 출발점이다.
  - **전제1:** 성소수자 가시화는 사회적 인식 개선과 정치 권력을 형성하는 데에 결정적인 영향을 미쳐 성소수자 해방을 위해 필수적이다.
    - 미디어는 성소수자의 존재를 '드러낼 수 있는 공간'이며 가시화는 존재 부정으로부터 인정으로 전환하는 사회적 과정을 만들어낸다.
    - 미국 동성애자 시트콤 시청자들은 비시청자보다 동성애자에 대한 편견 지수가 평균 12% 낮았으며, 시청 빈도가 높을수록 사회적 거리감이 줄어드는 경향을 보였다. (Schiappa, 2006)
	- 결과적으로 가시화는 시민권, 인권 담론, 젠더 규범 논의의 전제 조건으로 작용한다.
    - ‘성소수자 해방’이란 젠더 규범이 해체되고, 다양한 성정체성이 제도적·사회적으로 승인되며, 타인의 정체화에 대한 혐오적 시선이 사라진 사회적 상태를 의미한다.  
  - **전제2:** 미디어에서의 성소수자 재현의 양적 증가는 젠더 및 섹슈얼리티 규범을 교란하는 정체성의 반복 수행으로 성소수자 가시화 행위다.
    - 시청자 인식이 변화하고 시민권의 운동의 영향으로 성소수자 캐릭터가 점차 도입되었다.
    - Butler(1993)의 수행성 개념에 따르면, 젠더 규범은 반복적 실천을 통해 전복 가능하다. 즉, ‘피상적 재현’이라 하더라도 반복적 노출은 젠더 규범의 경계를 흔들며 사회 인식의 변화를 촉발한다.
    - 성소수자 캐릭터의 반복적 등장 자체가 규범을 해체하는 정치적 수행으로 기능하며 성소수자 가시화의 예시이다.
  - **전제3:** 성소수자 가시화에 있어 미디어에서의 성소수자 재현 부족으로 인한 해악이 피상적 재현의 위험성보다 훨씬 크다. 
...
- **결론:** 성소수자 재현의 왜곡과 위험은 비판과 교정을 통해 개선될 수 있지만, 존재의 부정은 교정될 수 없다. 비가시성은 해방의 가능성을 원천적으로 차단하며, 양적 증가만이 사회 인식의 변화를 이끄는 최소 조건이다. 따라서 미디어에서의 성소수자 재현의 양적 증가는 질적으로 불완전하더라도 해방을 위한 필수적 출발점이다.  
...
- **재반박:**Gerbner와 Gross(1976)는 ‘상징적 소멸(symbolic annihilation)’이라는 개념을 통해, 미디어에 등장하지 않는 집단은 사회적으로 존재하지 않는 것으로 간주된다고 지적한다. 따라서 최소한의 가시화를 통해 존재를 드러내는 것이 담론 형성과 정치적 주체화의 시작점이다. ‘잘못된 보임’은 고쳐질 수 있지만, ‘아예 안 보임’은 고칠 수 없다.
