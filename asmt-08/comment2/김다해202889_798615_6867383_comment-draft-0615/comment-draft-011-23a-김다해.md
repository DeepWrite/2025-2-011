---
title: 011-23 김다해의 코멘트a (과제-08) 
layout: home
nav_order: 23
parent: 011-11 김도현 (과제-08)
permalink: /asmt-08/011-11/comment-011-23
---
...
(구분하는 것이 복잡해 총평에 한 번에 적었습니다!)

먼저 서론 부분에서 다루시는 부분을 명확하게 제시하여 주시면서 글을 읽기 편했고 논쟁을 최소화할 수 있었다는 생각이 들었습니다. 그러나 다루지 않는 부분을 말씀하시면서 '책임의 비율은 다루지 않겠다'라고 말씀하셨는데 이 부분에서 조금의 수정이 필요해보입니다. 차등적으로 책임을 부과하려면 책임의 비율을 다루는 게 필수적이라고 생각합니다. 또한, 태훈님께서도 후반부에 책임의 비율을 특정 수치들로 언급하고 계시고요. 물론 글을 쓰실 때 의도는 '정확히 누구와 누구가 어느 비율로 책임을 져야한다'를 다루지 않는다는 것인 것 같은데 문장상으로는 오해를 불러일으킬 수 있을 것 같습니다. 그래서 이 부분을 조금 더 명확히 표현해 책임의 비율에서 어느 측면을 다루지 않을 것이신지 범주화해주시면 좋을 것 같습니다.

또한, 전제 1을 통해 탄소 배출량과 환경 파괴의 인과성을 입증하고자 하셨는데요, 이에 대해 조금 더 명확한 근거가 필요해보입니다. 글을 읽으면서는 단순히 다른 기관들에서 많이 채택하고 있다는 것을 근거로 사용하시고 계신다는 느낌이 들었습니다. 그래서 채택 기관과 채택 빈도에 대한 언급보단 왜 그것을 채택해야만 하는지를 더 설명해주시면 좋을 것 같습니다. 

그리고 책임을 물으실 때 본질적으로 변화시킨 행위 주체에게만 책임을 묻는 방식을 사용하신다고 했는데, 과연 질적 평가가 이루어지지 않는 상황에서 단순히 양적 평가만 한다고해서 설득력을 가질 수 있는지 의문입니다. 세세한 것들은 고려하지 않는 것을 전제하고 논증문을 전개해나가시는 것 같기에 수정하기는 어려워보이지만, 조금 아쉬운 방법으로 책임을 물으시고 계신 것 같아 아쉬웠습니다.

마지막으로 중국이 개발 도상국이라고 언급하고 계시는데, 해당 자료에서 선진국과 개발 도상국을 구분하는 기준이 무엇인가요? 전통적인 선진국이라고 하셨는데 그 기준을 명확히 하여야 선진국과 개발 도상국의 책임을 비교할 수 있을 것 같습니다. 저는 중국이 선진국이라고 생각했는데 개발 도상국에 포함되어 있어서 조금 의아함이 느껴졌습니다.

한 학기 동안 수고하셨습니다! 남은 과제도 화이팅하세요~