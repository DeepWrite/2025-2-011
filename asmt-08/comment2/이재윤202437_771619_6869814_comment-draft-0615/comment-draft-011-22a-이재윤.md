...
permalink: /asmt-08/011-11/comment-011-22
---
...
- **종합적 평가**: 
논문이 다루는 딜레마와 세부 쟁점들이 명확히 정정리되었다.
...
- **종합적 평가**: 
논문이 주장하려는 바가 명확(기후 위기의 원인이 선진국에 더 크게 있다는 것)하다. 그러나 기후 위기의 원인에 대한 책임을 선진국과 개발도상국 중 누구에게 더 크게 물을 것인지는 논쟁의 여지가 있는지 파악이 어려운데, 개발도상국에게 더 큰 책임을 부여해야 한다는 선행 연구 입장을 추가하면 좋을 것 같다.
...
- **종합적 평가**: 
자신이 주장하고자 하는 논제를 적절히 옹호하는 논증 전략을 사용하였다.
...
- **종합적 평가**: 
신뢰할 만한 참고문헌을 사용하였으며, 적절한 부분을 필자의 핵심적인 논변을 강화하거나 반론을 제시하기 위해 인용되고 있다.
...
#### **5. 서론 작성 종합 평가**: 
학습한 내용을 기반으로 하여 적절한 서론을 작성하였다. 다만, 학자들의 선행연구를 언급함에 있어 한계점을 추가적으로 제시한다면 본고의 주장과 선행 연구 간의 긴밀성이 드러나 본고의 주장이 등장해야만 하는는 필요성을 뒷받침할 수 있을 것이다.
...
#### **3. 본론 작성 종합 평가**: 
본문의 대부분은 학습한 바를 적절히 적용하여 완성되었으나, 재반박의 경우 세대 간 책임 분리론을 인정하여 한게 책임만을 기준으로 하였을 때도 같은 내용을 주장할 수 있음을 근거로 반론에 대하여 재반박을 하고 있다. 이 점에서 반론을 일부 받아들이고 있다고 보여지는데, 세대 간 책임분리론에 대한 재반박을 진행하여 논증구조에 대한 타당성을 확보하는 것이 보다 옳은 방향성일 것으로 보인다.
...
#### **4. 결론 작성 종합 평가**: 
결론은 본문에서 다룬 내용을 적절한 수준으로 요약하여 재진술함으로써 독자의 이해를 도왔다. 그러나 기여에 대한 서술이 빠져있어, 해당 연구가 기존 연구와 어떻게 차별화되며, 어떤 점에서 유사한지 파악하기 어렵다는 한계가 존재한다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

전반적으로 수업시간에 학습한 내용을 적절히 적용하였다.

### B. 논증에 대한 평가

어떠한 논증구조를 사용하고자 하였는지가 명확히 드러난다.