---
title: 011-26 박고은의 코멘트b (과제-08) 
layout: home
nav_order: 26
parent: 011-19 유영명 (과제-08)
permalink: /asmt-08/011-19/comment-011-26
---
...
- **종합적 평가**: 혐오 콘텐츠에 대한 사업자의 책임과 규제 필요성이 있다는 논제가 명확히 드러났습니다. 
...
- **종합적 평가**: 논증의 요소가 기능적으로 분리되어 제시되고 있습니다.
...
- **종합적 평가**: 플랫폼을 적극적 행위자로 볼 수 있을지, 개입이 정당한지에 대한 세부 쟁점들이 드러났습니다.
...
- **종합적 평가**: 논쟁의 여지가 있는 쟁점을 설정하였다고 느껴집니다.
...
- **종합적 평가**: 본론 첫 문단에서 논증 전략을 드러내고 있음을 확인할 수 있습니다. 논증 순서를 그렇게 정하게 된 타당성이 더욱 명확히 느껴진다면 좋을 것 같습니다.
...
- **종합적 평가**: 주 논증과 보조 논증들의 연결성을 확인할 수 있었으며, 학술 문헌과 그에 동반된 실증 사례의 뒷받침이 충분하다고 느껴졌습니다.
...
#### **5. 서론 작성 종합 평가**: 
논증 전개 순서와 논증 전략에 대한 소개를 보완한다면 독자 입장에서 앞으로의 글의 전개 방향 및 생각해볼 수 있는 부분을 선명히 파악할 수 있을 것 같습니다.
...
#### **3. 본론 작성 종합 평가**: 
전반적으로 문헌적, 실증적인 측면에서 내용이 뒷받침이 되고 있다고 느껴집니다. 또 동기 능력에 따른 책임 부여라는 책임에 대한 전제를 숨기지 않고 드러내어 책임의 원천을 명확히 한 점도 좋았습니다. 또 예상 반론이 본 논증의 어떤 전제를 공격하는지도 명확히 드러나 있습니다.
다만 논증에 제시된 내용의 순서가 조정된다면 플랫폼의 책임의 당위성을 더 효과적으로 드러낼 수 있을 것 같습니다. 책임이 행위 능력에 기반한다는 대전제 언급 이후, 플랫폼이 행위자로서 구조를 설계하는 행위 능력이 있으며 그러한 플랫폼의 작동으로 인해 혐오표현 방임등의 해악이 실제로 초래되었다는 실증적인 뒷받침이 이어진다면 더 자연스러운 흐름이 될 수 있을 것 같습니다.
...
#### **4. 결론 작성 종합 평가**: 
논의의 범위가 결론에서 다시 한 번 확정되며 독자의 오해를 방지하고 있다고 느껴집니다. 논증의 함의도 충분히 제시되었습니다. 추가적으로 해당 논증이 기존 문헌에서 다루지 못한 어떤 문제를 해결하고자 했는지가 보완된다면 좋을 것 같습니다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가
표현과 형식면에서 오해의 여지가 적으며, 전반적으로 가독성 있게 쓰였다고 느껴집니다. 

### B. 논증에 대한 평가
예상반론 부분에서 생산자나 출판자에 책임이 한정되어야 한다는 Laidlaw & Young의 논증이 보다 구체적으로 제시된다면 좋을 것 같습니다. 책임의 범위를 왜 생산/출판에 한정하는지, 그 전제가 가시적으로 드러나면 재반박의 효과성을 높일 수 있을 것 같습니다.
