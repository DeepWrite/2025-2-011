---
title: 011-26 박고은의 코멘트c (과제-08) 
layout: home
nav_order: 26
parent: 011-23 김성철 (과제-08)
permalink: /asmt-08/011-23/comment-011-26
---
...
표현 면에서 논증이 전달하고자 하는 바가 명확히 드러나있다고 느꼈습니다. 글에서 여러 번 진술을 확인할 수 있었습니다.
...
- **종합적 평가**: 논증에서 특별히 누락되었다고 느낀 요소가 없었습니다.
...
- **종합적 평가**: 포털 책임 논쟁과, 개입에 따른 자유 침해와 관련하여 선택의 딜레마가 명확히 드러났습니다.
...
- **종합적 평가**: 논쟁의 여지가 충분한 쟁점을 설정하였습니다.
...
- **종합적 평가**: 본론 첫 문단에서 뉴스 시장에 대한 포털의 영향력을 확인했으나, 이것이 곧 책임의 원천이 될 수 있다는 점에 대해서는 추가적인 논증 보완이 필요하다고 느껴집니다.
...
- **종합적 평가**: 책임 논변에서 추가적으로 Gillespie(2018)의 핵심 논증 내용과 논증 전략과 함께 보완될 수 있을 것 같습니다.
...
#### **5. 서론 작성 종합 평가**: 
본론의 전개방향에 대한 안내가 되는 서론이었습니다.이어질 논증의 구조 및 핵심 근거를 예상하며 읽을 수 있었습니다.
...
#### **3. 본론 작성 종합 평가**: 
포털의 기능과 영향 문단에서, Gillespie(2018)가 포털이 대중 간 담론 형성에 영향을 주고, 이 영향력이 기존 언론을 능가한다고 언급이 되어 있는데, 영향을 주는 방식이나 영향력 비교와 같은 해당 학자의 논증이 더욱 구체적으로 드러나야 포털의 책임을 지우는 것이 정당하다고 느껴질 것 같습니다. 예상 반론에서 Mann, R. J.와 Belzley, S. R.(2005)은 중개자가 수동적 역할을 할 때 그에 대한 책임을 묻는 것이 부적절하다고 하였는데, 적극적 편집권 행사의 측면에서 해당 학자들도 책임에 동의할 것으로 보입니다. 편집 또한 수동적 중개 행위에 해당된다는 점이 보완되어야 예상반론의 적절성을 확보할 수 있을 것 같습니다.
...
#### **4. 결론 작성 종합 평가**: 
한국 사회의 뉴스 소비 특수성을 미루어볼 때 논증의 범위 설정이 더욱 타당하다고 느껴졌습니다. 개인적인 생각으로 이처럼 논의 범위를 '포털'으로 설정한 배경을 서론에서 보여주신다면 해당 맥락에서의 논증의 의의가 더 잘 느껴질 것 같습니다.
또 결론 앞부분의 논증 요약 등 요소와 시사점이 양적으로 균형을 이룰 수 있도록 하면 형식적으로도 안정적인 글이 될 것이라 생각합니다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

결론에 드러난 딜레마 해결의 의의 및 논증이 기여하고자 하는 바가 서론에서도 일정부분 드러난다면 더욱 좋을 것 같습니다. 동시에 결론에서 해당 부분의 비중을 조금 줄인다면 결론의 다른 요소들, 논증 요약 및 

### B. 논증에 대한 평가

책임 논증에서의 Gillespie의 포털 영향력 관련 핵심 논증이 보완된다면 연결되는 논증의 설득력도 더욱 커질 수 있을 것 같습니다. 