---
title: 011-11 김도현의 코멘트a (과제-08) 
layout: home
nav_order: 11
parent: 011-13 김태훈 (과제-08)
permalink: /asmt-08/011-13/comment-011-11
---
...
본고의 쟁점은 "환경가치의 보존을 위해서는 경제의 규모를 축소하고 성장을 중단해야 하는가" 이다. 이에 대해 필자가 주장하는 바는 1)환경가치의 보존을 위해서는 경제의 규모를 축소해야 하고, 2)축소된 경제 하에서도 환경가치 보존이 가능하다는 것인데,
이때 1은 핵심 쟁점과 곧바로 연결되는 주장이지만, 2는 "경제를 축소하여도 환경가치 보존이 가능한가?" 라는 쟁점에 대한 주장에 가깝다. "환경가치의 보존을 위해서는 경제의 규모를 축소해야 하는가" 라는 쟁점과  "경제를 축소하여도 환경가치 보존이 가능한가?" 라는 쟁점은 얼핏 보기에는 비슷해 보이지만, 전자는 경제 규모 축소를 독립변수로, 환경가치 보존을 종속변수로 설정해 '경제 규모'에 초점을 맞추는 후자는 반대로 경제 규모 축소를 전제로 가정하여 환경가치 보존에 초점을 맞추고 있다. 두 가지 주장 중 필자가 다루려고 하는 주제만 기술하는 것이 좋을 듯 하다.

또한, '경제성장 억제 시 환경가치 저하의 부작용이 발생할 수 있다는 반론'의 서술에서 제기된 반론은 "개발도상국에서는 빈곤 문제가 나타나 생존을 위해 환경을 파괴하는 사례가 종종 보고된다"는 것 이였다. 이에 필자는 재반박을 하며 반론이 "빈곤이 환경가치의 저하로 필연적으로 이어진다는 것을 전제"하고 있음을 제시하였는데, 빈곤 -> 환경가치 저하의 사례가 종종 보고된다는 것과 빈곤과 환경가치 저하의 필연성을 전제하고 있는 것은 아닌 만큼, 재반박이 반론의 논지를 명확히 파악하지 못한 채 이루어진 것으로 보인다.
