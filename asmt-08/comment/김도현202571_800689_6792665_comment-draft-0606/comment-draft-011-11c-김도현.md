---
title: 011-11 김도현의 코멘트c (과제-08) 
layout: home
nav_order: 11
parent: 011-23 김다해 (과제-08)
permalink: /asmt-08/011-23/comment-011-11
---
...
우선 서론에서 제시된 세대 간 형평론자의 개념을 설명해주는 것이 좋을 듯 하다. 또한, 탈성장 개념의 명확한 설정은 좋으나 서론에 들어가는게 더 적절할 것으로 생각된다. 
한편, 본지는 탈성장만이 현재의 환경 위기와 세대 간 불평등 문제를 해결할 수 있는 유일한 방법이라는 것을 논증하는 방법으로 녹색 성장, 기술 혁신과 같은 대안들이 환경 파괴를 막을 수 없다는 것을 증명하는 것을 채택하였는데, 이는 탈성장을 해야 하는 이유로 충분하지 않아 보인다. 몇 개의 대안들이 무용하다는 것을 논증하는 것만으로는 주장하고자 하는 대안인 탈성장이 그 대안으로 채택되어야 한다는 사실을 받아들이기 어렵다.
또한, 칸트&롤스가 미래 세대와의 형평성을 고려했다는 것 만으로는 미래세대가 동등한 도덕적 지위를 가졌다는 것, 나아가 이를 당위적으로 고려해야 한다는 것의 근거로 충분하지 않다고 생각한다.
### 논증을 진술하는 문장들 표현 평가