---
title: 011-13 유성보의 코멘트c (과제-04) 
layout: home
nav_order: 13
parent: 011-21 조윤진 (과제-04)
permalink: /asmt-04/011-21/comment-011-13
---
...
서론에서 핵심 주장이 명확히 드러나 있고, 본론의 논증 구조와 서술 순서를 제시해 전개 방향을 예측할 수 있었다. Cohen과 MacCannell의 대립구도를 드러내면서도 각각의 한계를 지적해 본문의 논의가 갖는 함의를 자연스럽게 예측할 수 있었다. 

본론에서도 첫 단락에서 진정성을 관광객의 인식 측면에서 해체하고 두번째 단락에서 문화의 가변성을 근거로 제시해 논증을 점진적으로 심화해 문화 상품화가 진정성을 필연적으로 파괴한다는 명제가 틀렸음을 입증한다. 논증의 취약점을 공격하는 예상 반론에 대한 재반박 역시 논리적이다.

결론은 기존 논증을 재정리하고, 새로운 주장 없이 불필요한 오해를 방지하게끔 작성되었다. 전반적으로 잘 작성된 논증문라고 생각된다.
