---
title: 011-13 유성보의 코멘트b (과제-04) 
layout: home
nav_order: 13
parent: 011-17 전예원 (과제-04)
permalink: /asmt-04/011-17/comment-011-13
---
...
서론에서 핵심 주장이 명확하게 나타나 있으며, 본론의 논증 순서와 전개 순서를 구체적으로 제시해 본문의 전개를 예측할 수 있다. 본론에서도 각 단락이 공유된 불만이라는 감정적, 인지적 기반이 디지털 환경 하에서 어떻게 노동자들의 전략적 행동으로 전환되는 지 그 과정을 점진적이고 필연적으로 제시하고 있다. 반론과 재반박 단락 역시 논증의 취약한 부분을 점검하고 논증을 강화하는 역할을 충실하게 수행했다. 

다만 결론 부분에 플랫폼 노동자에 대한 제도적 대응이라는 새로운 주장을 더한 부분이 논증문의 일관성을 떨어뜨리는 요인으로 작용한다. 이 부분을 제거한다면 더 타당한 논증문이 될 것이다.
