---
title: 011-16 정윤서의 코멘트a (과제-04) 
layout: home
nav_order: 16
parent: 011-08 김준서 (과제-04)
permalink: /asmt-04/011-08/comment-011-16
---
...
이 글은 보조금의 실효성을 민간 투자를 촉진하는 것이 가능한지 여부를 토대로 낭비되는 재원임을 보이고자 한다. 주장을 명확히 설정하였으나, 주장을 뒷받침하는 핵심 근거가 부족한 듯 보인다. 실제 사례들을 실증 분석한 자료를 바탕으로 주장하려고 하였으나, **경향이 있다**와 같은 표현은 그러지 예외를 포함하는 듯 보여, 충분한 논거가 되기에는 부족하다. 사례를 통한 귀납적 논증 방법을 선택한다면, 충분한 사례들을 다뤘다는 다른 자료의 근거가 필요할 것으로 보인다. 

또한 반론을 제기하는 부분에서도 보조금이 민간 투자를 구축하는 효과를 설명한 논증을 반박한 것이 아니라 단순히 보조금은 민간 투자를 촉진한다는 반대 입장을 나열한 것에 그치는 걸로 보인다. 따라서 이 글을 전체적으로 민간 투자를 구축하는 논증을 구축하고 그 논증을 반박하는 다층적 구조를 띠닌 글을 설계해야한다. 마지막으로 결론 부분에서 본 글이 어떤 의의를 가지고 논의한 영역을 구체적으로 명시함으로써 논의 지점 범위를 명확히 설정하는 것이 필요하다. 
