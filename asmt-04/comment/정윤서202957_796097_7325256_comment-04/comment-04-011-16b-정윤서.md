...
## 코멘트
 ...
 이 글은 전반적으로 서론-본론-결론에서 요구하는 필수적인 내용을 구조적으로 잘 배치한 것으로 보인다. 본론 1장에서 **인류의 장기적 삶의 질**을 높이기 위한 전제로 **지속가능성**을 제시하고, **GMO**가 그를 위협한다는 구조는 논리적으로 연결성이 있다. 그러나 주장을 뒷받침하는 근거로 단순히 정보를 나열한 데에 아쉬움이 있다. 예컨대, GMO가 지속가능성을 위협하는 이유로 슈퍼 잡초를 제시하였는데 반론에서는 슈퍼 잡초에 대한 반론이 아닌 현실적 긴급한 문제를 해결하기 위한 내용을 제시한 점은 본 글의 핵심 근거를 반론한 것이 아닌 단순히 주장에 대한 반론을 제시한 셈이 된다. 또한 핵심 근거를 제시할 때에도 여러 차원에서 제시하는 것이 아닌, 논리적으로 누적되고 점층된 근거를 제시해야할 것이다. 
