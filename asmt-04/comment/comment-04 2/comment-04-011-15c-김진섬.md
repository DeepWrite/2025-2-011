---
title: 011-15 김진섬의 코멘트c (과제-04) 
layout: home
nav_order: 15
parent: 011-19 유영명 (과제-04)
permalink: /asmt-04/011-19/comment-011-15
---
...
이 글은 자율주행차의 탑승자 보호와 공동선 우선 설계 사이의 윤리적·사회적 긴장을 잘 포착하고 있으며, 반론과 재반박 부분에서 설득력 있는 논증을 전개하고 있다. 또한, 서론에서 쟁점 설정이나 선행 연구 소개는 독자가 논의의 주제를 명확히 알게 한다는 점에서 장점이다.

다만 몇 가지 아쉬움도 존재한다. 먼저 서론에서는 논증의 순서와 전개 흐름이 충분히 설명되지 않아, 독자가 본론에서 전개될 논지를 미리 파악하기 어렵다. 다음으로 본론1과 본론2의 주장 자체는 연결돼 보이나, 그 근거를 세부적으로 보면 논리적 연결이 다소 미흡하다. 예를 들어, 본론1에서 “자동차의 본질은 교통수단이며, 탑승자는 안전하게 이동할 권리가 있다”고 논증했으므로, 본론2에서는 이를 기반으로 “이 권리를 보장하는 차량만이 사회적 수용성을 얻을 수 있다”고 주장을 전개하면 훨씬 유기적이고 설득력 있는 흐름이 될 수 있다. 현재 과제글은 본론2의 논증이 연결되어 있음에도 불구하고 독립적으로 제시되어 연결성이 약해 보인다. 또한 반론의 내용은 본론2의 논지를 반대하는 주장으로, 올바른 예상 반론으로 보기 어렵다. 반론은 독자의 의심이나 논리적 허점을 겨냥해야 하는데, 반론은 오히려 본론2의 논리를 약화시키는 진술을 반복하는 구조가 되어 있다. 마지막으로 결론 부분은 논의의 의미와 오해 해소, 기여 측면에서는 장점이 있지만, 논증의 핵심 구조 요약이 명확히 드러나지 않아 글 전체의 논증적 완결성을 높이는 데 아쉬움이 있다.
