---
title: 011-23 김성철의 코멘트c (과제-04) 
layout: home
nav_order: 23
parent: 011-27 김가희 (과제-04)
permalink: /asmt-04/011-27/comment-011-23
---
...
이 글은 과학적 필요성과 윤리적 책임 사이에서 동물실험의 딜레마에 대해 분석하고 있다. 서론은 Kiani(2022), Regan(1983)과 Akhtar(2011)의 입장을 대비시키면서 자신의 주장을 명시하고 있다. 보완하자면, 관련된 학술 논의의 입장이 각각 지니는 한계를 추가적으로 제시할 수 있을 것이다.

본론은 논제 → 핵심 근거1 → 핵심 근거2 → 예상 반론 및 재반박 → 결론의 형태를 갖추고 있다. 그러나 각 단락이 필연적으로 다음 단락으로 이어지는 논리적 연결고리를 가지는 필연적 흐름이라기보다는, 병렬적 나열에 가까워 보인다. 그리고 예상 반론-재반박 역시 양립 불가능한 입장 사이에서 이루어지는, 취약 지점에 대한 지적과 이에 대한 대응이라기보다는 타협적인 서술로 보인다. 결론은 본론에서 제시한 내용을 요약하며, 논의의 결론이 기존 연구와 어떻게 차별화되는지 제시하고, 어떤 기여를 하는지 설명하였다. 주장의 의미와 방향을 정리함으로써 전체 글을 구조적으로 마무리하고 있다.
