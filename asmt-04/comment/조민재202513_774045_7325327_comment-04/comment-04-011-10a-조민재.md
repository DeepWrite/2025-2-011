---
title: 011-10 조민재의 코멘트a (과제-04)
layout: home
nav_order: 10
parent: 011-02 차승철 (과제-04)
permalink: /asmt-04/011-02/comment-011-10
---
...
정치권력의 정당성에 대한 입장을 홉스-주권자, 로크-인민으로 구분되는데 논제는 정당성을 명시하는 절차가 필요하다로 나타나 있다. 본론의 첫 번째 논증에서 인민의 입장에서 쉽게 받아들이기 어렵다는 설명은 논증에서 근거가 충분하지 않은 것으로 보인다. 두 번째 논증은 이해하기 어려웠다. 확립된 정당성의 근거가 있다면 정당화할 수 있다. 그러면, 첫 번째 논증에서 확립한 절차에 정당성이 존재해야한다가 내용인 것 같은데 논증이 정당성은 강제해야 한다인지, 규제할 수 있는 능력을 가져야 한다인지 등 독자 입장에서 애매하게 다가오는 것 같다. 
