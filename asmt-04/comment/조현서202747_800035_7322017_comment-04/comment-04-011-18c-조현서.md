...
이 글은 서론-본론-결론의 큰 틀과 문제의식이 뚜렷한 점이 강점이지만, 읽는 길을 더 분명히 하려면 서론 마지막에 “먼저 친밀성 개념의 핵심을 규정하고, 다음 국가개입의 역설을 보이며, 마지막으로 현대화 반론을 검토·재반박할 것이다"와 같이 문장 로드맵을 넣어 전개 순서를 예고해 주면 좋을 것 같다. 본론은 각 절을 주제문 → 핵심 근거 1–2개 → 미니결론(논제와의 연결)로 동일 구성을 맞추고, 단락 끝마다 다음 단락으로 넘어가는 연결문을 추가하면 논증 흐름이 끊기지 않는다.  인용은 한 문장으로 요지를 압축해 본문 흐름 안에 녹이고, 긴 설명은 각주·주석로 보내 가독성을 높이는 편이 더 좋을 것 같다. 결론은 새로운 정보나 장황한 주석을 덜고, 전제→추론→결론을 3–4문장으로 재요약한 뒤 “폐지”라는 최종 입장과 적용 범위(명백한 학대 개입의 예외 등)를 한 문장으로 명시하면 완결성이 살아날 것이다. 마지막으로 핵심 개념어(‘친밀성의 관계’, ‘국친권’)는 서론에서 짧게 정의하고 글 전반에 일관된 표현을 유지하면 전체 구조가 더 단단해질 수 있다.
