---
title: 011-18 조현서의 코멘트b (과제-04) 
layout: home
nav_order: 18
parent: 011-14 서시현 (과제-04)
permalink: /asmt-04/011-14/comment-011-18
---
...
구성 면에서 장점은 서론–본론–결론의 큰 틀과 총후생과 소비자 복지라는 핵심 대비가 분명하다는 점입니다. 다만 서론 첫 단락에서 논제와 입장을 조금 불분명한 부분이 있어 명확한 한 문장으로 못 박고(“반독점 집행은 효율성 판단이므로 총후생을 기준으로 삼아야 한다” 등), 곧바로 1문장의 로드맵을 통해 앞으로의 내용을 제시해 전개를 예고해 준다면 글의 내용을 보다 더 예측하기 좋을 것 같다. 용어 정의(소비자 복지, 총후생)는 서론 중간에 각 1문장으로 간결히 두고, 판례·학자 소개는 한 문장씩로 압축한다면 배경과 논제의 연결을 분명해질 수 있다. 본론의 각 절은 반드시 주제문 → 근거(간단한 모형·간단한 사례) → 미니결론(“따라서 …이므로 총후생가 적합”)의 동일한 리듬을 유지하고, 단락 말미에 다음 절로 넘어가는 연결문을 넣어 준다면 글의 흐름이 조금 더 자연스러워질 것이다. 긴 사례 서술은 핵심 변수(가격·수량·잉여 변화)만 남기고 2–3문장으로 요약하거나 각주로 보내면 글이 조금 더 간결해져 핵심 논지와의 연결이 더 명확해진다. 반론–재반박은 하나의 단락 안에서 가장 강한 반론 1개만 제시하고, 같은 수준의 구체성으로 바로 반박해 “대응 쌍”을 만들면 구조가 선명해질 것이다. 결론은 새로운 정보 없이 전제→추론→결론을 3–4문장으로 재요약하고, 적용 범위와 한계를 1문장으로 밝힌다면 과도한 일반화를 피할 수 있다. 전체적으로 문장을 짧게, 접속어(따라서/반대로/즉)를 적극 활용해 논증의 인과를 드러내면 구성 완성도가 한층 높아질 수 있을 것 같다.
