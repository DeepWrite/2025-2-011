---
title: 011-23 김다해 (과제-09)
layout: home
nav_order: 23
parent: 과제-09 기말과제 최종본
permalink: /asmt-09/011-23
---

# (최종본) 과제-09 기말과제 011-23 김다해  

# 제목: 탈성장의 필요성 - 환경 위기와 세대 간 불평등을 해결할 사실상 유일한 해결책 

## 서론

2024년 기준, 산업화 이전 시대 대비 지구의 평균 기온은 약 1.55°C가 상승했다.[^1] 이러한 급격한 증가는 현재의 환경 위기가 얼마나 심각한지 명확히 보여주고 있다. 기후 변화는 단순히 환경적 문제가 아니라, 극한 기후, 해수면 상승, 식량 위기 등을 초래하며 인류의 생존 자체를 직접적으로 위협하고 있다. 이같은 지구 온난화 현상의 주요 원인으로는 화석 연료의 사용이 지목된다. 전체 온실가스 배출량의 약 70%이상이 화석 연료 사용에서 비롯되고 있으며, 화석 연료의 사용은 경제 성장과 밀접하게 연결되어 있다. 두 요인 사이에는 강한 인과관계가 존재한다.[^2] 이러한 배경에서 경제 성장은 단순히 경제적인 지표를 넘어 환경 보존을 위한 핵심적인 고려사항으로 떠오르고 있다. 이에 따라 세대 간 형평론자들과 이론가들 사이에선 이같은 환경 위기를 해결하기 위한 방법으로 탈성장이 필수적인지 치열하게 논쟁 중이다. 이에 본고는 탈성장이 필수적이라는 입장에 힘을 실으며 탈성장만이 현재의 환경 위기와 세대 간 불평등 문제를 해결할 수 있는 사실상 유일한 방법이라는 것을 논증하고자 한다.

우선 세대 간 형평론자 사이에서도 탈성장만을 유일한 방법으로 볼 수 있는지에 대해 입장 차이가 존재한다. 여기서 세대 간 형평론자란, 자원의 이용과 환경적 부담을 한 세대에 집중시키지 않고, 미래 세대와의 공정한 분배와 책임을 중시하는 입장을 가진 이론가들을 말한다. 탈성장만이 유일한 해결책이라고 주장하는 대표적인 학자 중에는 Giorgos Kallis가 있으며, 그는 기술적 낙관주의를 비판하며 기술 혁신만으로는 환경 문제를 해결할 수 없다고 강조한다.[^3] 그는 경제 성장이 환경 위기의 구조적 원인이라고 보며, 성장 자체를 멈추지 않고서는 진정한 세대 간 정의는 달성될 수 없다고 본다. 반면, 탈성장을 유일한 방법으로 보지는 않지만, 탈성장의 필요성을 인정하며 정책적 전환을 함께 주장하는 입장도 존재한다.[^4] 이들은 급진적인 성장 중단보다는 성장의 질과 방향을 바꾸는 데 주목하며 현실 정치와 경제 시스템 속에서의 점진적 개입을 중요하게 생각한다. 이에 비해 탈성장의 위험성을 지적하며 녹색 성장이나 기술 혁신을 대안으로 제시하는 학자들은 경제 성장이 환경 개선과 반드시 충돌하지만은 않는다고 본다.[^5] 이들은 친환경 기술, 에너지 전환, 효율성 향상 등의 수단을 통해 성장과 지속가능성을 동시에 달성할 수 있다고 주장하며, 경제 성장의 사회적 필요성을 여전히 강조한다. 더 나아가 양 측의 입장을 모두 절충하려는 시도도 등장하고 있다.[^6] 이들은 탈성장의 급진성과 녹색 성장의 한계 사이에서 실질적인 대안을 찾고자하며 복지 같은 다른 기준을 통해 세대 간 형평을 추구하고자 한다. 이처럼 세대 간 형평론자들 사이에서도 탈성장과 녹색 성장을 둘러싼 다양한 입장과 갈등이 공존하고 있다.

본고의 핵심 목표는 현행 경제 성장 모델이 구조적으로 환경 파괴를 수반하며, 이에 따라 탈성장이 사실상 유일한 해결책이라는 점을 논증하는 것이다. 이를 위해 다음과 같은 논증 구조를 따른다. (1) 먼저, 경제 성장이 환경 파괴를 필연적으로 수반하는 구조적 특성을 논증한다. 이는 경제 성장의 핵심 전제가 대량 생산·소비, 자원 채굴, 에너지 소모 등 생태적 수용 능력을 초과하는 방식에 기반하고 있다는 데 있으며, 특히 GDP 중심 성장 전략이 생태계 지속 가능성과 모순된다는 사실을 실증적 자료를 통해 입증한다. (2) 이어서, 이러한 환경 파괴가 단지 현재 세대의 문제가 아니라 미래 세대의 생존 기반을 침해한다는 점에서, 세대 간 형평성의 원칙에 위배됨을 논증한다. 이 논증은 롤즈의 ‘무지의 베일’ 개념, 칸트의 도덕적 보편주의, 아렌트의 사회적 신뢰 개념 등을 통해 윤리적 정당성을 확보하며, 동시에 IPCC 및 UNEP 등의 자료를 활용해 실증적으로도 정당화한다. (3) 다음으로, 녹색 성장이나 기술 혁신 등 기존 성장 패러다임의 수정론적 접근이 환경 위기의 근본적 해결책이 될 수 없다는 한계를 실증적으로 논증한다. Parrique(2019), Pueyo(2019), Yaqiong et al.(2021) 등의 연구를 바탕으로 기술 중심 접근이 열역학적 제약과 기존 제도 구조에 의해 본질적으로 제한된다는 점을 보여준다. (4) 이러한 논증을 종합하면, 경제 성장이 유지되는 한 환경 위기와 세대 간 불평등은 필연적으로 지속되며, 따라서 탈성장만이 사실상 유일하게 윤리적·생태적으로 정당한 해결책임을 논리적으로 도출할 수 있다. (5) 결론적으로 본고는 탈성장이 단순한 이념적 대안이 아니라, 실질적 위기 상황에서 가장 근본적이며 정당한 정책적·철학적 전환의 요청임을 주장하며, 이에 따른 함의와 과제를 마지막에서 논의한다.
...
'탈성장'은 말 그대로 성장에서 벗어난다(脫成長)는 의미로 사용되고 있다. 여기서 언급하는 '성장'은 경제 성장을 의미하며 이에 대한 정의는 학자들 사이에서도 다양하게 논의되고 있다. 따라서 본고는 논의의 명확성을 위해 경제 성장에 대해 명확한 정의를 내리고자 한다. 본고는 World Bank의 개념 사전에서 제시한 정의인 '일정 기간 동안 한 국가 또는 지역의 국내총생산량(GDP)또는 1인당 GDP가 실질적으로 증가하는 현상으로 재화와 서비스의 총생산량이 증가하는 현상'을 채택하고자 한다.[^7] 이와 같은 GDP 중심의 정의는 국제적으로 통용되는 표준 지표에 기반하고 있으며, UN, OECD, IMF 등 주요 국제기구와 정부들 모두 이를 실무 기준으로 사용하고 있다.[^8] [^9] [^10] 또한, 이 정의는 현재의 성장 패러다임이 지닌 구조적 특성을 잘 드러낼 수 있으며, 학문 간 통용성도 높다. 따라서 본고는 이러한 정의를 바탕으로, 경제 성장의 환경적·윤리적 한계를 분석하고자 한다.

#### 환경 파괴의 발생 이유

위와 같은 경제적 성장을 달성하기 위해서는 환경 파괴가 필수적으로 동반될 수밖에 없는 구조적 한계가 존재한다. 현재의 경제 성장 모델은 대량 생산과 소비를 기반으로 하며, 이러한 방식의 성장은 필연적으로 자원의 고갈과 온실가스 배출을 유발한다. 앞서 서론에서도 언급했듯, 화석연료가 경제 성장에 미치는 영향은 계량경제학적 분석을 통해 실증적으로 입증된 바 있다.[^11] 해당 연구는 에너지 소비와 자원 사용, 그리고 GDP 성장 사이에 강력한 인과 관계가 존재함을 보여준다. 또 다른 연구에서는 화석연료가 경제 성장의 ‘엔진’ 역할을 한다고 평가하며, 화석연료 소비와 경제활동이 환경 파괴 및 자원 고갈과 밀접하게 연관되어 있음을 지적한다.[^12]특히 GDP 성장률 중심의 정책은 자원의 한계를 고려하지 않은 채 단기적인 경제적 이익만을 추구하기 때문에, 장기적으로는 지구의 생태적 수용 능력(planetary boundaries)을 초과할 수밖에 없다.[^13] 결국, 경제 성장을 추구하는 것은 환경 붕괴를 필연적으로 유발하는 선택이라고 할 수 있다.

### 세대 간 불평등을 초래하는 환경 파괴

#### 미래 세대 평등 고려의 필요성

환경 파괴는 단순히 현재 살아가고 있는 인류에게만 영향을 미치는 것이 아니다. 환경과 지구는 수세기를 걸쳐도 영향 받는 채로, 영향 받은 채로 유지되기 때문에 미래 세대에 대한 고려가 필수적으로 필요하다. 이러한 부분은 도덕적으로 고려되어야 하며, 다양한 철학자들이 현대 국가가 미래 세대를 위한 세대간 평등을 고려해야 한다고 주장한다. 우선 롤즈의 정의론을 발췌한 Rawls(1971)를 보면, 그가 직접적으로 미래 세대에 대한 책임을 다루고 있지는 않지만, 그의 핵심 주장과 일부 문장들을 통해 미래 세대에 대해 고려하고 있다는 것을 확인할 수 있다. 또한, 칸트의 입장을 정리한 글인 Eterovic(2021)을 통해서 칸트 또한 미래 세대에게 미치는 영향에 대해 도덕적으로 책임을 져야한다고 주장한 것을 확인할 수 있다.
